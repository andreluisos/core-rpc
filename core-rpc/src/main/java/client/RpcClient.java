...
/**
 * Wrapper around {@link RpcStreamer} This class should be used for communication. It provides
 * convenience factory methods
 *
 * <p>All calls are passed down to underlying {@link RpcStreamer}
 *
 * <p>Examples:
 *
 * <pre>
...
public final class RpcClient implements RpcStreamer {
    ...
    private static ExecutorService createDefaultExecutorService() {
        return new ThreadPoolExecutor(
                2, 4, 10000, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>());
    }
    ...
    private static RpcSender createAsyncRpcSender(
    ...
    private static RpcListener createAsyncRpcListener(
            ExecutorService executorService, ObjectMapper objectMapper) {
    ...
    private static RpcStreamer createDefaultAsyncRpcStreamer(
            ExecutorService executorService, ObjectMapper objectMapper) {
        return createRpcStreamer(
                createAsyncRpcSender(executorService, objectMapper),
    ...
    /**
     * Creates a default instance of {@link RpcClient} based on: * {@link PackStream} for two-way
     * communication * {@link AsyncRpcSender} for sending data * {@link BackgroundRpcListener} for
     * receiving data
     *
    ...
    /**
     * Builder for {@link RpcClient} to simplify configuration Everything is set to default at the
     * start and following may be changed: * Underlying {@link RpcStreamer} * If default {@link
     * RpcStreamer} is used, {@link RpcSender} and {@link RpcListener} may be changed * If default
     * {@link RpcSender} or {@link RpcListener} are used, {@link ObjectMapper} and {@link
     * ExecutorService} can be changed
     */
    public static class Builder {
        ...
        /**
         * Creates a default {@link RpcClient} builder If build is called right after this, default
         * instance will be <b>created</b>
         */
        public Builder() {}

        /**
         * Changes default {@link RpcStreamer} with the one given After this change is made,
         * dependencies of the default {@link RpcStreamer} can not be changed
         *
        ...
        /**
         * Changes default {@link RpcSender} with the one given After this change, default {@link
         * RpcStreamer} is used and its dependencies may be changed
         *
        ...
        /**
         * Changes default {@link RpcListener} with the one given After this change, default {@link
         * RpcStreamer} is used and its dependencies may be changed
         *
        ...
        /**
         * Changes default {@link RpcListener} and {@link RpcSender} with the ones given After this
         * change, default {@link RpcStreamer} is used and its dependencies may be changed
         *
         * @param rpcSender {@link RpcSender} instance to use
         * @param rpcListener {@link RpcListener} instance to use
         * @return instance of a different, more limited builder
         */
        public DefaultRpcStreamerFullBuilder withRpcSenderAndListener(
                RpcSender rpcSender, RpcListener rpcListener) {
        ...
        public static class DefaultRpcStreamerFullBuilder {
            ...
            /**
             * Creates a new {@link RpcClient} instance with default {@link RpcStreamer} and given
             * sender and listener
             */
            public RpcClient build() {
        ...
        public static class CustomRpcSenderBuilder {
            ...
            private CustomRpcSenderBuilder(
                    RpcSender rpcSender,
            ...
            /**
             * Changes default {@link RpcListener} with instance given After this change, default
             * {@link RpcListener} and its dependencies are discarded
             *
             * @param rpcListener {@link RpcListener} instance to use
            ...
            /**
             * Changes {@link ExecutorService} used by default {@link RpcListener} with instance
             * given
             *
            ...
            /**
             * Creates a new {@link RpcClient} instance with default {@link RpcStreamer}, default
             * {@link RpcListener} with given {@link ObjectMapper} and {@link ExecutorService},
             * together with custom {@link RpcSender}
             */
            public RpcClient build() {
                return new RpcClient(
                        createRpcStreamer(
                                rpcSender, createAsyncRpcListener(executorService, objectMapper)));
            }
        }
        ...
        public static class CustomRpcListenerBuilder {
            ...
            private CustomRpcListenerBuilder(
            ...
            /**
             * Changes default {@link RpcSender} with instance given After this change, default
             * {@link RpcSender} and its dependencies are discarded
             *
             * @param rpcSender {@link RpcSender} instance to use
             * @return an instance of a different, more limited builder
             */
            ...
            /**
             * Creates a new {@link RpcClient} instance with default {@link RpcStreamer}, default
             * {@link RpcSender} with given {@link ObjectMapper} and {@link ExecutorService},
             * together with custom {@link RpcListener}
             */
            public RpcClient build() {
                return new RpcClient(
                        createRpcStreamer(
                                createAsyncRpcSender(executorService, objectMapper), rpcListener));
            }
        }
        ...
        /**
         * Creates a new {@link RpcClient} instance with default {@link RpcStreamer}, {@link
         * RpcSender} and {@link RpcListener} with custom dependencies for those ({@link
         * ExecutorService} and {@link ObjectMapper})
         */
        public RpcClient build() {
